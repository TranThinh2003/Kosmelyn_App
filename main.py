...
def main(page: Page):
    ...
    question_index = 0
    answers = []
    button_ = ElevatedButton(text="Show Item", on_click=lambda e: page.go("/Items"), width=200, height=70, visible=False    )
    ...
    upload_button = ElevatedButton("Upload", on_click=upload_files, disabled=True, visible = False)
            ...
            Container(
                content=Row(
                    controls=[
                        ...
                        Column(
                            controls=[
                                Text(f"Category: Name{i}"),
                                Text(f"Product Name: {20 + i}"),
                                Text(f"Brand: {2000 + i}"),
                                Text(f"Price: {i}"),
                                Text(f"Use for: {i}"),
                                Text(f"Higlighted Ingredients: {i}"),
                                Text(f"Skincare Concerns: {i}"),
                                Text(f"Skin type: {i}")
                            ],
